...
public class Animation {
    ...
    private ArrayList<ImageManager> frameImages;
    ...
    public Animation(){
        ...
        frameImages = new ArrayList<ImageManager>();
        isRepeated = true;
        drawRectFrame = false;
    ...
    public Animation(Animation animation){
        ...
        delayFrames = new ArrayList<Double>();
        for (Double a :animation.delayFrames){
            delayFrames.add(a);
        }
        ignoreFrames = new ArrayList<Boolean>();
        ...
        frameImages = new ArrayList<ImageManager>();
        for (ImageManager c :animation.frameImages){
            frameImages.add(c);
        }
    }
    ...
    public ArrayList<ImageManager> getFrameImages() {
        return frameImages;
    }

    public void setFrameImages(ArrayList<ImageManager> frameImages) {
    ...
    public void add(ImageManager frameImage,double timeToNextFrame){
    ...
    public void update(long currentTime){
        if (beginTime == 0){
            ...
            if (beginTime-currentTime>delayFrames.get(currentFrame)){
                nextFrame();
                beginTime=currentTime;
            }
        }
